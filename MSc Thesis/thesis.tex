...
INSERT DIAGRAM WITH CAD MODEL AND A 3d POINT TO ILLUSTRATE THE POINT??????????
...
\end{bmatrix*}
\]
\captionof{figure}{Rotation Matrix for rotation about Z, then Y, then X axes. The symbols $\alpha$, $\beta$ and $\gamma$ represent rotations about the x, y and z axes respectively.}
