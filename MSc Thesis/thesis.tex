...
Section on cable driven robots and the flexible arm paper, called "Existing Designs" or "Design inspiration" or whatever, mentioning choices similar and different to mark 1?? MENTION THE FLEXIBLE ARM PAPER FROM WALTERIO AND CABLE DRIVEN DESIGNS??
...
There are numerous existing designs that incorporate a single structure arm driven by cables connected to motors, such as those covered in \cite{godage2011} and \cite{zhang2011}. However, these designs relied on a method in which each connecting cable was driven by a single dedicated motor. This was improved upon in \cite{}, where a design was introduced that uses a single motor to drive a pair of opposing cables. This design was the inspiration for the first handheld robot prototype, as covered in \cite{GreggSmithDesign}. Given the similarities in the general design principles and handheld nature, inspiration was taken from the first prototype in the development of the new device.
...
In REFERENCE NEW ARM PAPER XXXXX, a flexible arm was.... XXXXX
