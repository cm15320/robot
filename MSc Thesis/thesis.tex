...
\begin{center}
\includegraphics[width=0.65\textwidth]{images/getSolution.png}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{images/separateThreads.png}
